...
Website: https://app.codility.com/programmers/lessons/2-arrays/odd_occurrences_in_array/
--------------------------------------------------------------------------------
...
def solution(A):
    ...
    if length == 1:
        ...
        myset = set(A) # Create a set of unique numbers in A
        for element in myset:
            count = A.count(element) # Count each and see if they occur an even or odd amount of times
            if count % 2 == 1:
                return element
